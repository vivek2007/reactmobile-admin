...
var defaultProps = {
  ...
  renderMenu: function renderMenu(results, menuProps, props) {
    return React.createElement(_TypeaheadMenu["default"], (0, _extends2["default"])({}, menuProps, {
  ...
  renderToken: function renderToken(option, props, idx) {
    return React.createElement(_Token["default"], {
...
var TypeaheadComponent = /*#__PURE__*/function (_React$Component) {
  ...
  function TypeaheadComponent() {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_instance", void 0);
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_renderInput", function (inputProps, props) {
      ...
      if (!multiple) {
        return React.createElement(_TypeaheadInputSingle["default"], commonProps);
      }

      var labelKey = props.labelKey,
          onRemove = props.onRemove,
          selected = props.selected;
      return React.createElement(_TypeaheadInputMulti["default"], (0, _extends2["default"])({}, commonProps, {
        selected: selected
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_renderAux", function (_ref) {
      ...
      if (isLoading) {
        content = React.createElement(_Loader["default"], null);
      } else if (clearButton && !disabled && selected.length) {
        content = React.createElement(_ClearButton["default"], {
          onClick: onClear,
  ...
  _proto.render = function render() {
    ...
    return React.createElement(_Typeahead["default"], (0, _extends2["default"])({}, this.props, {
      options: options,
      ...
      return React.createElement(_RootClose["default"], {
        ...
        }), props), React.createElement(_Overlay["default"], (0, _extends2["default"])({}, getOverlayProps(_this2.props), {
