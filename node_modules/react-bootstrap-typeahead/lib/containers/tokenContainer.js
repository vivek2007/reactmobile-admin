...
var _RootClose = _interopRequireDefault(require("../components/RootClose.react"));
...
var tokenContainer = function tokenContainer(Component) {
  var WrappedComponent = /*#__PURE__*/function (_React$Component) {
    ...
    _proto.render = function render() {
      ...
      return _react["default"].createElement(_RootClose["default"], {
        disabled: !active,
        onRootClose: this._handleBlur
      }, function (ref) {
        return _react["default"].createElement(Component, (0, _extends2["default"])({}, _this2.props, {
          active: active,
          onBlur: _this2._handleBlur,
          onClick: _this2._handleClick,
          onFocus: _this2._handleFocus,
          onKeyDown: _this2._handleKeyDown,
          onRemove: (0, _utils.isFunction)(onRemove) ? _this2._handleRemove : undefined,
          ref: ref
        }));
      });
    };
